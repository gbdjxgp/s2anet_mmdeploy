...
template void gather_topk_impl<float>(const float* input, const int* indices, const int64_t* dims,
                                      int nbDims, const int64_t* indices_dims, int indice_nbDims,
                                      float* output, cudaStream_t stream);

// template void gather_topk_impl<int32_t>(const int32_t* input, const int* indices, const int* dims,
//                                         int nbDims, const int* indices_dims, int indice_nbDims,
template void gather_topk_impl<int32_t>(const int32_t* input, const int* indices, const int64_t* dims,
                                        int nbDims, const int64_t* indices_dims, int indice_nbDims,
