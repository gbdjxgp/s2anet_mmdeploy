...
@FUNCTION_REWRITER.register_rewriter(
    func_name='mmrotate.models.dense_heads.odm_refine_head.'
    'ODMRefineHead.get_bboxes')
def odm_refine_head__get_bbox(ctx,
                              self,
                              cls_scores,
                              bbox_preds,
                              img_metas=None,
    ...
    # mlvl_priors = rois[0]
    mlvl_priors = [priors.unsqueeze(0) for priors in rois[0]]
